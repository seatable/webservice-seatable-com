...
sections:
    ...
    - name: "content-9"
      ...
      description: 'Mit SeaTable profitieren Sie von leistungsstarken [KI-Funktionen]({{< relref "pages/landing-pages/use-cases/ai-automations" >}}), die Ihre NPS-Umfragen und Feedback-Analysen auf ein neues Level heben. Automatisieren Sie Auswertungen und gewinnen Sie tiefere Einblicke in Kundenmeinungen.'
      items:
