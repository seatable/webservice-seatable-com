...
sections:
    ...
    - name: "content-25"
      ...
      - headline: 'Простое планирование благодаря наглядной визуализации'
        text: 'Вести обзор в чисто табличном графике строительства, как в Excel, очень утомительно. В SeaTable Вы можете визуализировать свой проект с помощью нашего временной шкалы без дополнительных затрат и усилий. Это позволит Вам идеально согласовать все сроки.'
      ...
      - headline: 'Вся работа с первого взгляда'
        text: 'Используйте представление временной шкалы или Kanban для визуализации состояния отдельных задач и расписаний. Это означает, что Вы всегда будете в курсе событий и сможете сразу же увидеть, какие последующие заказы будут затронуты в случае задержек.'
