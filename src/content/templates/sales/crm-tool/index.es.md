...
sections:
    ...
    - name: "content-9"
      ...
      description: Con el plantilla CRM de SeaTable, se beneficia de potentes [funciones de IA]({{< relref "pages/landing-pages/use-cases/ai-automations" >}}) integradas, que le ayudan a sacar el máximo partido a los datos de sus clientes. Automatice tareas y ahorre tiempo.
    ...
    - name: "faq"
      ...
      - q: "¿Puedo sincronizar mi calendario de Google con SeaTable?"
        a: 'Sí, SeaTable ofrece una [integración nativa con Google Calendar]({{< relref "help/integrationen/integrationen-innerhalb-von-seatable/google-calender-synchronisieren" >}}). Para ello, solo necesita su ID de Google Calendar y su clave de seguridad.'  
