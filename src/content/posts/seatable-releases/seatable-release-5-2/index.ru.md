...
**Предустановленные фильтры** в настройках данных теперь позволяют выбирать все соответствующие типы столбцов, включая [столбцы]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}}) [с формулами]({{< relref "help/base-editor/spaltentypen/die-formel-spalte" >}}) и [ссылками]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}}). Это устраняет важное функциональное ограничение в предварительной фильтрации данных. С внедрением групп фильтров в одной из следующих версий этот тип страницы будет предлагать такие же мощные возможности фильтрации, как и базовый.
