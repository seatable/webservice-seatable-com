...
A documentação completa para a criação do SAML pode ser encontrada no [SeaTable Admin Manual](https://admin.seatable.com/configuration/authentication/saml/).
