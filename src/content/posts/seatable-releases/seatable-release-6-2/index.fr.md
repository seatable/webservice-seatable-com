...
L'objet Context et la méthode Query renvoient désormais le contenu des colonnes Date, Formule ainsi que Formule de lien sous un format harmonisé. Ce changement de format peut provoquer des erreurs lors de l'exécution de vos scripts. Veuillez vérifier et mettre à jour vos scripts Python.
...
![Nouveau type de page HTML dans l'App Builder](HTMLPage.png)
...
![Nouvelle autorisation « Supprimer les entrées existantes »](AppBuilder_RemoveExistingRecords.png)
...
![La fonction datetimeFormat() dans la colonne de formule](FormulaColumn_datetimeFormat.png)
...
![Retour à la ligne dans une formule de type chaîne de caractères](FormulaColumn_LineBreak.png)
