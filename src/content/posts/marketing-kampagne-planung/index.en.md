...
SeaTable offers [ready-made templates]({{< relref "templates/marketing/" >}}) for various marketing campaigns, which can be flexibly adapted to your requirements or for other use cases, e.g. for [social media]({{< relref "templates/marketing/social-media-plan" >}}) or [editorial plans]({{< relref "templates/marketing/editorial-plan" >}}), a [competitor analysis]({{< relref "templates/marketing/competitor-analysis" >}}) or for planning your content marketing.
...
And best of all: The [SeaTable Cloud]({{< relref "pages/product/seatable-cloud" >}}) is hosted exclusively **on servers in Germany** and is ready to go in just a few minutes, without you having to wait for your IT.
