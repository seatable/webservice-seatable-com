...
Чтобы использовать SeaTable, достаточно бесплатно зарегистрироваться. Затем вы можете добавить [шаблон]({{< relref "templates/everyday-life/apartment-hunting" >}}) в свою базу и добавить свои собственные данные.
