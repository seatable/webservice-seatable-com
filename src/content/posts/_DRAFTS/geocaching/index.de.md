...
![Gruppe von Geocachern sucht versteckten Cache im Wald](gruppe-sucht-geocaches.png)
...
{{< warning headline="Weitere Cache-Arten" >}}
...
![Geocache-Box im Gras](geocache.png)
...
![Hinweise und Rätsel zum Geocaching auf einem Baum](hinweise-geocaching.png)
...
![Karte auf dem Waldboden zum Planen einer Geocaching-Tour](landkarte-im-wald.png)
...
![Kind orientiert sich mit Smartphone beim Geocaching](kind-sucht-orientierung.png)
...
{{< faq "Was ist ein Muggel im Geocaching?" >}}
...
{{< faq "Darf man Caches überall verstecken?" >}}
...
{{< faq "Was tun, wenn man den Cache nicht findet?" >}}
