...
Для этого SeaTable предлагает вам множество возможностей для сбора всех данных о клиентах в одном месте экономически эффективным, прибыльным и интуитивно понятным способом. Подразделения и сотрудники, имеющие к вам отношение, могут сразу же начать работать вместе как единая команда. Например, вы можете быстро назначить права на чтение и/или запись для отделов [продаж]({{< relref "templates/sales/sales-pipeline" >}}), [маркетинга]({{< relref "pages/landing-pages/industry-solutions/marketing" >}}), закупок или обслуживания клиентов.
