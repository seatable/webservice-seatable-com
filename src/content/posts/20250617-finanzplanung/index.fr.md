...
Dans la phase centrale de la planification financière, vous utilisez les données obtenues lors de la phase d'analyse pour élaborer votre [plan financier]({{< relref "pages/landing-pages/industry-solutions/finanzplan-erstellen" >}}) de manière prospective. Celui-ci peut être divisé en plusieurs domaines :
