...
Не забудьте указать в приглашениях важную информацию: дату, время, место проведения и программу. Чтобы облегчить гостям процесс бронирования, стоит интегрировать систему бронирования билетов. С помощью [веб-формы]({{< relref "help/base-editor/webformulare" >}}) в готовом [шаблоне]({{< relref "templates/marketing/event-management" >}}) от SeaTable вы сможете легко реализовать этот шаг и автоматически создать список участников.
