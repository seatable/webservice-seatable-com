...
Auf der anderen Seite kommen verschiedene Studien u. a. von McKinsey oder KPMG zu dem Ergebnis, dass KI gerade in Forecasting, Qualitätssicherung und Servicemanagement enormes Potential bietet. Und dennoch scheitern viele KI-Projekte im Operations Management – und zwar in der Regel nicht an den gewählten KI-Tools, sondern an einer fehlenden gemeinsamen Datenbasis. Hinzu kommt wachsender Druck in Richtung [Datensouveränität]({{< relref "posts/digitale-souveraenitaet" >}}): Wer sensible Betriebsdaten an externe KI-Plattformen anbinden will, **braucht klare Datenhoheit und nachvollziehbare Governance** statt unkontrollierter [Schatten-IT]({{< relref "posts/schatten-it" >}}).  
...
![Fragmentierte Datenstrukturen behindern KI-Einsatz im Operations Management](ki_im_operations_management_01.png)    
...
![Strategisches und operatives Prozessmanagement ganzheitlich gedacht](ki_im_operations_management_04.png)
...
![KI bietet ein großes Prozessoptimierungspotential im Operations Management ](ki_im_operations_management_02.png)    
...
![KI-Einsatz im Operations Management braucht verknüpfte Daten](ki_im_operations_management_03.png)
