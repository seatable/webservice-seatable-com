...
1\. Создайте пустую доску: Доска - это основа, с которой Вы будете работать в дальнейшем. Не торопитесь думать о том, какие этапы работы Вы хотите отобразить на доске, вместо того, чтобы заполнять ее всем своим бэклогом. Если Вы используете бескодовое решение, такое как SeaTable, Вы можете воспользоваться Kanban.
