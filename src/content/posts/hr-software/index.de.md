...
-   **Arbeitszeittracker**: Eine Fülle an HR Tools (wie Clockodo, Clockify, Timebutler, TimeTac usw.) greift sich nur den Aspekt der [Arbeitszeiterfassung]({{< relref "pages/landing-pages/use-cases/arbeitszeiterfassung" >}}) heraus. Sie sind darauf ausgelegt, die tägliche Arbeitsdauer zu messen und Projekten zuzuordnen, Urlaubsanträge einzureichen und krankheitsbedingte Ausfälle zu dokumentieren. Da sie nur diese einfachen Prozesse abbilden können, wirken sie im Vergleich zu anderer HR Software eher rudimentär.  
...
Lesen Sie mehr über die [Erfahrungen von Personio Kunden]({{< relref "posts/personio-erfahrungen" >}}) oder sehen Sie sich direkt eine [Personio Alternative]({{< relref "pages/landing-pages/alternatives/personio-alternative" >}}) an.
