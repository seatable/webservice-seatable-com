...
Теневые ИТ – это ИТ-системы и программные приложения, которые сотрудники специализированных отделов компании используют **без ведома ИТ-отдела** для дополнения или обхода официальной [ИТ-инфраструктуры]({{< relref "posts/it-infrastruktur" >}}).
