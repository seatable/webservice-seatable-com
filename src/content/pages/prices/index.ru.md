      ...
      table:
          ...
          rows:
              ...
              - key: 'Запусков JavaScript (в месяц)'
                values: ['∞', '∞', '∞', '∞']
              - key: 'Запусков Python (в месяц на одного пользователя)'
                values: ['100 (фикс.)', '250', '1.000', '∞']
              - key: 'Вызовы API (в месяц на одного пользователя)'
                values: ['3.000 (фикс.)','10.000','50.000','∞']
              - type: section
                label: 'Функции'
