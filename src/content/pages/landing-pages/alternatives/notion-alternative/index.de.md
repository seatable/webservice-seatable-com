...
sections:
    ...
    - name: "content-4"
      ...
      - icon: palette
        ...
        text: "Erstellen Sie professionelle Dokumente und Berichte unmittelbar aus Ihren Daten. Per Schaltfläche oder Automatisierung erzeugen Sie druckfertige PDFs und versenden sie direkt aus dem System per E-Mail."
    ...
    - name: content-12
      ...
      image_alt: 'SeaTable als Notion-Alternative für Projektmanagement und Wissensmanagement'    
    ...
    - name: 'content-8'
      ...
      description: 'Um Ihnen den Einstieg so einfach wie möglich zu machen, gibt es zahlreiche kostenlose, **sofort nutzbare Vorlagen, YouTube-Videos und zahlreiche [Hilfe-Artikel]({{< relref "help/" >}})**, die Sie bei den ersten Schritten begleiten. Egal, ob Sie eine Software für Wissensmanagement oder einen Projektplan brauchen.'
      items:
          - text: Projektstrukturplan
            image: /images/notion-alternative-template-workbreakdown.png
            image_alt: 'SeaTables Projektstrukturplan-Vorlage für smartes Projektmanagement'
          - text: Produkteinführung
            image: /images/notion-alternative-template-produktlaunch.png
            image_alt: 'SeaTables Vorlage für erfolgreiche Produkteinführung'
          - text: Workshop-Planer
            image: /images/notion-alternative-template-workshop.png
            image_alt: 'SeaTables Workshop-Planer-Vorlage für erfolgreiche Events'
      buttons:
    ...
    - name: content-25
      ...
      - headline: "Echte Tabellenverknüpfungen"
        text: In Notion ist jede Datenbank eigentlich ein Notizzettel. Verknüpfungen sind auf eine Ebene beschränkt, Rollups verarbeiten maximal 25 Werte und Lookups sind editierbare Auswahlfelder ohne Validierung. Mit SeaTable erstellen Sie **sauber strukturierte, integre und relationale Daten** über mehrere Ebenen. 
        image: /images/landing-page-notion-alternative-02.png
        image_alt: 'Mit SeaTable als Notio-Alternative nutzen Sie die Power echter relationaler Datenverknüpfungen'

      - headline: "Dokumente, Dashboards und Visualisierungen"
        text: 'Die Notion-Alternative SeaTable ist mehr als eine reine Datenbank. Mit dem integrierten Whiteboard erstellen Sie **freie Skizzen und Prozessvisualisierungen**. Mit dem Page Designer und dem Report Builder erzeugen Sie **druckfertige Dokumente und Berichte** direkt aus Ihren Tabellen. Und mit dem Statistikmodul bauen Sie **ansprechende Analyse- und Monitoring-Dashboards**.'
        image: /images/landing-page-notion-alternative-03.png
        image_alt: 'SeaTable bietet als Notion-Alternative für ansprechende Dashboards und Datenvisualisierungen'

      - headline: "Chat, Benachrichtigungen und E-Mail-Integration"
        text: "Mit Notion benötigt Ihr Team externe Kanäle, um sich über Aufgaben auszutauschen. **SeaTable bietet dafür integrierte Funktionen**: Mit der Chat-Funktion tauschen Sie sich zu einzelnen Aufgaben aus und bei wichigen Entwicklungen erhalten Sie automatisch eine Nachricht. Eine nativen E-Mail-Integration erlaubt den E-Mail-Versand direkt aus der Datenbank."
        image: /images/landing-page-notion-alternative-04.png
        image_alt: 'SeaTable als Notion-Alternative bietet integrierte Kommunikations-Features'

      - headline: "App Builder"
        text: "Mit Notion brauchen Sie externe Tools, um aus Ihren Seiten Anwendungen zu bauen. In SeaTable ist der App Builder direkt integriert. So bauen Sie im Handumdrehen aus jeder Base **flexibel anpassbare Apps** mit Formularen, Listenansichten und **rollenbasierten Zugriffsrechten**, die Sie bei Bedarf **mit Passwortschutz für Externe** freigegeben."
        image: /images/landing-page-notion-alternative-05.png
        image_alt: 'Mit SeaTable als Notion-Alternative erstellen Sie Frontends und Self-Service-Portale' 
        
      - headline: "Automatisierte Workflows"
        text: Notions Automationen sind eingeschränkt und können keine mehrstufigen Workflows verarbeiten. SeaTable bietet native Automationen mit Triggern auf Basis von Zeitplänen, Statuswechseln oder neuen Einträgen, und mehrfachen Aktionen mit [integrierten KI-Funktionen]({{< relref "posts/ai-in-seatable" >}}). 
    ...
    - name: 'content-3'
      ...
      items:
          - headline: SeaTable Cloud
            ...
            image_alt: 'SeaTable Cloud als ideale Notion-Alternative'
          - headline: SeaTable Server
            text: Für Unternehmen, die die volle Kontrolle über ihre Daten behalten wollen.
            image: /images/seatable_server_v1.png
            image_alt: 'SeaTable Server als Notion-Alternative für volle Datenkontrolle'
          - headline: SeaTable Dedicated
            ...
            image_alt: 'SeaTable Dedicated Umgebung für skalierbares Projekt- und Wissensmanagement im Unternehmen'    
    ...
    - name: faq
      ...
      items:
          ...
          - q: Bietet SeaTable auch einen Support an?
            a: Ja, SeaTable bietet neben umfangreichen Hilfe-Artikeln und [YouTube-Tutorials](https://www.youtube.com/@SeaTable) auch einen kostenfreien Support über unser Forum. Sie können uns auch direkt über unser Kontaktformular oder per E-Mail kontaktieren. 
