...
sections:
    ...
    - name: content-3
      ...
      description: 'Avec SeaTable, vous avez le choix entre deux options de déploiement performantes pour votre [gestion des flux de travail]({{< relref "pages/landing-pages/industry-solutions/individual" >}}).'
      items:
