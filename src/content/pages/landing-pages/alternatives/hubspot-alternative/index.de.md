...
sections:
    - name: hero-5
      ...
      buttons:
          - label: Jetzt kostenlos loslegen
            ...
            style: primary
            id: de-hubspot-registration
          - label: Funktionen kennenlernen
            link: pages/functions

    - name: "content-4"
      weight: 2
      title: Ihre maßgeschneiderte Hubspot-Alternative 
      subtitle: Individualisierbare CRM- und Marketing-Lösung
      text: 
      items:
      - icon: edit
        headline: Flexibel statt vordefiniert
        text: "Mit SeaTable definieren Sie, wie Kontakte, Deals und Kampagnen strukturiert werden – nicht das System. Neue Felder, Verknüpfungen und Ansichten sind in Sekunden ergänzt, ohne Ticket oder Support-Wartezeit."

      - icon: robot
        headline: KI-gestützte Automatisierungen
        text: "Lead-Qualifizierung, Follow-up-Erinnerungen und Meeting-Notizen: Erstellen Sie intelligente Workflows für größere Produktivität mit unseren integrierten KI-Funktionen – gehostet auf unserem eigenen KI-Server."

      - icon: people-group
        headline: Eine Plattform für alle Teams
        text: "Datensilos, Redundazen oder Intransparenz waren gestern. In SeaTable arbeiten alle Teams gemeinsam in Echtzeit. So verfügt jeder stets über aktuelle Informationen."
      
      - icon: chart-simple
        headline: Reports und Analysen
        text: "In SeaTable erstellen Sie ansprechende Dashboards und Reports nach Ihren Vorstellungen und teilen Sie mit Ihren Stakeholdern – ohne Tool-Switch und Datenexport. So arbeiten Sie jederzeit mit aktuellen Analysen."

      - icon: up-right-and-down-left-from-center
        headline: Kampagnen, Pipelines, Tickets
        text: "Mit SeaTable verbinden Sie Marketing-, Vertriebs- und Kundenservicedaten in einer gemeinsamen Struktur. So sehen Sie in Echtzeit, was wirklich funktioniert und Umsatz erzeugt."
      
      - icon: terminal
        headline: Cloud oder on-premises
        text: "SeaTable Cloud und die SeaTable KI werden DSGVO-konform auf europäischen Servern in Deutschland gehostet. Oder nutzen Sie SeaTable self-hosted auf Ihrer eigenen Infrastruktur."
    ...
    - name: content-12
      ...
      items:
        ...
        - text: "Einfache Integration und Individualisierung **ohne IT-Unterstützung und Programmieraufwand**"
    ...
    - name: content-25
      weight: 4
      title: 'Lead Scoring bis Kundengespräch: SeaTable in der Praxis'
      subtitle: Ihre zentrale Datenbasis für Leads, Kunden und Kampagnen
      items:
    ...
    - name: faq
      ...
      items:
          ...
          - q: "Wie einfach lassen sich Daten von Hubspot zu SeaTable migrieren?"
