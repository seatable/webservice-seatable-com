...
sections:
    ...
    - name: content-12
      ...
      description: Avec [la solution IA no-code]({{< relref "/" >}}) SeaTable, vous utilisez un outil de planification uniforme, allant des besoins en capitaux et du [plan de financement]({{< relref "posts/20250617-finanzplanung" >}}) aux analyses financières. Consolidez automatiquement toutes les données pertinentes dans une source unique et bénéficiez d'une transparence maximale, remplaçant [le chaos Excel]({{< relref "pages/landing-pages/alternatives/excel-alternative" >}}).
      items:
