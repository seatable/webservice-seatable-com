...
sections:
    ...
    - name: content-12
      ...
      description: 'Avec la plateforme [IA No-Code]({{< relref "/" >}}), SeaTable vous offre un outil flexible de gestion de projet pour concevoir [des processus personnalisés]({{< relref "pages/landing-pages/industry-solutions/individual" >}}). Utilisez les automatisations intégrées et les droits accès granulaires pour des projets agiles et une gestion efficace des parties prenantes.'
      items:
