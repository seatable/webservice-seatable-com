...
- SeaTable (Cloud или Server) **версии 6.0** или выше
- База с таблицей, содержащей текстовые данные

{{< warning headline="Примечание для клиентов с самостоятельным хостингом" >}}

В **SeaTable Cloud** ИИ-сервер уже интегрирован. SeaTable использует собственную языковую модель (Gemma 4) на GPU-инфраструктуре в Германии — вы можете использовать ИИ-автоматизации сразу.
