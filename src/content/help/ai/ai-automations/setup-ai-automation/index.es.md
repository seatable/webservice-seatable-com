...
En **SeaTable Cloud**, el servidor de IA ya está integrado. SeaTable opera su propio modelo lingüístico (Gemma 4) en infraestructura GPU en Alemania — puede utilizar las automatizaciones IA de inmediato.
