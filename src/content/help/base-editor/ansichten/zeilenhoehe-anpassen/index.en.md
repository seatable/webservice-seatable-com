...
By default, SeaTable displays all rows in table views with a compact row height to show as many records as possible. However, with this **default row height**, among other things, [text]({{< relref "help/base-editor/spaltentypen/die-spalte-formatierter-text" >}}), [link]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}})and [multiple select columns]({{< relref "help/base-editor/spaltentypen/die-mehrfachauswahl-spalte" >}}) are truncated and only small **thumbnails** of images are displayed.
