...
En [el plugin de calendario]({{< relref "help/base-editor/ansichten/die-kalender-ansicht" >}}) y en [la página de calendario en aplicaciones]{{< relref "help/app-builder/seitentypen-in-universellen-apps/kalenderseiten-in-universellen-apps" >}}), sin embargo, aún puede configurar el primer día de la semana de forma individual e independiente de la configuración en la base.