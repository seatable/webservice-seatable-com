...
- **No se pueden modificar** las entradas [enlazadas]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}}) en las entradas de big data. Los enlaces a filas de la memoria de big data **no se muestran** en las vistas normales, pero sí en una vista de big data.
