...
- Vous ne pouvez **pas modifier**[les entrées liées]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}}) dans les entrées Big Data. Les liens vers des lignes dans le stockage Big Data ne sont **pas affichés** dans les vues normales - mais le sont dans une vue Big Data.
