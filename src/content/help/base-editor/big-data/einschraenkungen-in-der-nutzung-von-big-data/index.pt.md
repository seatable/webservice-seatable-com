...
- **Não é possível modificar**[entradas ligadas]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}}) em entradas de grandes volumes de dados. As ligações a linhas na memória de grandes volumes de dados **não** são apresentadas em vistas normais - mas são apresentadas numa vista de grandes volumes de dados.
