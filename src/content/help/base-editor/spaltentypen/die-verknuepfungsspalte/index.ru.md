...
categories:
    - 'verknuepfungen'
author: 'kgr'
url: '/ru/pomoshch/kolonka-ssylok'
aliases:
    - '/ru/pomoshch/wie-man-tabellen-in-seatable-miteinander-verknuepft'
    - '/ru/pomoshch/kak-svyazat-tablitsy-seatable'
seo:
    title: 'Колонка ссылок в SeaTable: инструкция'
    description: 'В SeaTable можно связать между собой через специальную колонку — подробный гайд по созданию, редактированию и работе с связями.'
...
![ограничение ссылок с помощью правила фильтрации](images/limit-row-selection-using-a-filter-rule.png)
