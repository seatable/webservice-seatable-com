...
Está disponível um total de **cinco fórmulas diferentes** para o tipo de coluna. O pré-requisito para utilizar a coluna é a existência de pelo menos uma coluna do tipo [Ligação a outras entradas]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}}) na sua tabela.
