...
В общей сложности для этого типа столбцов доступно **пять различных формул**. Необходимым условием использования столбца является наличие в Вашей таблице хотя бы одного столбца типа [ссылка на другие записи]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}}).
