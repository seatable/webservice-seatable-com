...
Функция поиска может быть использована только в том случае, если колонка типа _Ссылка на другие записи_ уже существует. Если у вас еще нет такой колонки, сначала создайте ее. Вы можете узнать, как это работает, [здесь]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}}).
