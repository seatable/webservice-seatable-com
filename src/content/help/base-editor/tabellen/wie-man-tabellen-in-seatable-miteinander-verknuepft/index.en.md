...
4. Click **Submit**.
5. The content of the new column is still empty. To fill it, you can **link existing records** or **add new rows** .
...
This setting is especially useful for [filtered views]({{< relref "help/base-editor/tabellen/wie-man-tabellen-in-seatable-miteinander-verknuepft" >}}#7-toc-title) this setting can be helpful if you want to specifically link **individual records** in your tables.
