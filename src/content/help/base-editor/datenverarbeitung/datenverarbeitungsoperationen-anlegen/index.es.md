...
Para las demás operaciones, necesitará en parte columnas de [enlace]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}})**(comparar y enlazar** y **comparar y copiar**) o [columnas de texto]({{< relref "help/base-editor/spaltentypen/die-spalten-text-und-formatierter-text" >}})**(transferir nombre de usuario**).
