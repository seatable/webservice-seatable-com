...
Para as outras operações, é necessário em parte [ligar colunas]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}})**(comparar e ligar** & **comparar e copiar**) ou [colunas de texto]({{< relref "help/base-editor/spaltentypen/die-spalten-text-und-formatierter-text" >}})**(transferir nome de utilizador**).
