...
Pour les autres opérations, vous avez parfois besoin de [colonnes de liaison]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}})**(Comparer et relier** & **Comparer et copier**) ou [de colonnes de texte]({{< relref "help/base-editor/spaltentypen/die-spalten-text-und-formatierter-text" >}})**(Transférer le nom d'utilisateur**).
