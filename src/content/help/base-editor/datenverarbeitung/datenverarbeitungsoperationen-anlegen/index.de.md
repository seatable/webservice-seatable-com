...
Für die übrigen Operationen brauchen Sie zum Teil [Verknüpfungsspalten]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}}) (**Vergleichen und verknüpfen** & **Vergleichen und kopieren**) oder [Text-Spalten]({{< relref "help/base-editor/spaltentypen/die-spalten-text-und-formatierter-text" >}}) (**Benutzername übertragen**).
