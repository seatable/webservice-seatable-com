...
Для других операций вам частично понадобятся [колонки ссылок]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}})**(сравнить и связать**, **сравнить и скопировать**) или [текстовые колонки]({{< relref "help/base-editor/spaltentypen/die-spalten-text-und-formatierter-text" >}})**(перенести имя пользователя**).
