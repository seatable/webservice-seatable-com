...
[Подробнее о текстовой колонке]({{< relref "help/base-editor/spaltentypen/die-text-spalte" >}})
...
[Подробнее о колонке Длинный текст]({{< relref "help/base-editor/spaltentypen/die-spalte-formatierter-text" >}})
...
Для получения дополнительной информации о типе колонки Ссылка на другие записи, [нажмите здесь]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}}).
