...
Если в качестве значения по умолчанию в [текстовом столбце]({{< relref "help/base-editor/spaltentypen/die-text-spalte" >}}) указать ссылку **{creator.name}** или **{creator.id}**, то автоматически вводится **имя** или **идентификатор пользователя**, добавившего строку.
...
- в [колонке ссылок]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}})
