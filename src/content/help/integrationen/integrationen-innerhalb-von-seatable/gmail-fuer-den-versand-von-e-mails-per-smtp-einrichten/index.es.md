...
Para que SeaTable pueda acceder a una cuenta de Gmail mediante OAuth 2.0, debe crear un ID de cliente y una clave de cliente en la Cloud Console de Google y guardarlos en SeaTable.
...
1. El cliente recién creado aparece ahora en la lista de clientes OAuth 2.0. La configuración del cliente se puede mostrar haciendo clic en su nombre. El ID de cliente mostrado y el secreto de cliente son esenciales para la configuración posterior en SeaTable.
...
5. Introduzca la siguiente información:
    ...
    - **Nombre de la cuenta**: cualquier nombre para la cuenta, por ejemplo, 'Gmail'
    - **ID de cliente**: el ID de cliente del cliente OAuth creado
    - **Secreto de cliente**: el secreto de cliente del cliente OAuth creado

6. Haz clic en **Siguiente** cuando se te notifique que esta aplicación no ha sido verificada y permite el acceso a la cuenta de Google.
