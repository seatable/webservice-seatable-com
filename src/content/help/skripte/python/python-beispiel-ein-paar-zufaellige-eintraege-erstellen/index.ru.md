...
{{< dtable-download name="Random Entries" file="/downloads/python-examples/random-entries.dtable" text="База с подходящей структурой таблицы и готовым скриптом для непосредственного тестирования." />}}
