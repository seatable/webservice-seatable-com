---
title: 'Пример Python: Конвертация HEIC в PNG'
date: 2023-03-02
lastmod: '2026-03-18'
categories:
    - 'javascript-python'
author: 'cdb'
url: '/ru/pomoshch/python-konvertatsiya-heic-png'
---

Этот скрипт конвертирует файлы изображений HEIC (часто используемые устройствами Apple) в формат PNG.
