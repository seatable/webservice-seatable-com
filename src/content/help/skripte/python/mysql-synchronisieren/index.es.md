---
title: 'Ejemplo Python: Sincronizar datos MySQL'
date: 2023-03-02
lastmod: '2026-03-18'
categories:
    - 'javascript-python'
author: 'cdb'
url: '/es/ayuda/python-sincronizar-mysql'
---

Este script sincroniza datos de una base de datos MySQL a una tabla de SeaTable. Compara registros existentes por nombre y solo agrega entradas que aún no existen en SeaTable.
