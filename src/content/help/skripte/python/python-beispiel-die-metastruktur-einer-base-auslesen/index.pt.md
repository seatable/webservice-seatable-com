...
![Saída da metaestrutura no SeaTable](base-metadata.png)

{{< dtable-download name="Base Metadata" file="/downloads/python-examples/base-metadata.dtable" text="Base com várias tabelas e ligações para experimentar." />}}
