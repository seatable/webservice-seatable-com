---
title: 'Пример Python: Объединение PDF-файлов'
date: 2023-03-02
lastmod: '2026-03-18'
categories:
    - 'javascript-python'
author: 'cdb'
url: '/ru/pomoshch/python-obedinenie-pdf'
---

Этот скрипт объединяет несколько PDF-файлов из столбца файлов в один PDF-документ и сохраняет результат обратно в строку.
