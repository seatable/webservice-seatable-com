---
title: 'Ejemplo Python: Fusionar archivos PDF'
date: 2023-03-02
lastmod: '2026-03-18'
categories:
    - 'javascript-python'
author: 'cdb'
url: '/es/ayuda/python-fusionar-pdf'
---

Este script fusiona varios archivos PDF almacenados en una columna de archivos en un único documento PDF y guarda el resultado de vuelta en la fila.
