---
title: 'JavaScript example: Add rows automatically'
date: 2023-03-02
lastmod: '2026-03-18'
categories:
    - 'javascript-python'
author: 'cdb'
url: '/help/javascript-auto-add-rows'
seo:
    title: 'JavaScript: Automatically add rows to SeaTable'
    description: 'Use this JavaScript script to automatically add recurring entries to your SeaTable base with duplicate checking and date handling.'
---

This script automatically adds expense entries to a ledger table. It checks whether an entry for the current month already exists before adding a new one -- perfect for recurring monthly entries like office supplies or software licenses.
