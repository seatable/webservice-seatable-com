---
title: 'Ejemplo JavaScript: Agregar filas automáticamente'
date: 2023-03-02
lastmod: '2026-03-18'
categories:
    - 'javascript-python'
author: 'cdb'
url: '/es/ayuda/javascript-agregar-filas'
---

Este script agrega automáticamente entradas de gastos en una tabla. Verifica si ya existe una entrada para el mes actual antes de crear una nueva.
