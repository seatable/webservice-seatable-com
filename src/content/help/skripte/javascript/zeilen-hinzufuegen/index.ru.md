---
title: 'Пример JavaScript: Автоматическое добавление строк'
date: 2023-03-02
lastmod: '2026-03-18'
categories:
    - 'javascript-python'
author: 'cdb'
url: '/ru/pomoshch/javascript-dobavlenie-strok'
---

Этот скрипт автоматически добавляет записи расходов в таблицу. Проверяет, существует ли запись за текущий месяц, прежде чем создавать новую.
