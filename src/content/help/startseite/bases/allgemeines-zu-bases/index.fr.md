...
- Fonctions de [base de données relationnelle]({{< relref "posts/relationale-datenbank" >}}) et [liens entre les tableaux]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}})
