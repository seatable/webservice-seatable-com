...
- Funções das [bases de dados relacionais]({{< relref "posts/relationale-datenbank" >}}) e a [ligação de tabelas]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}})
