...
- Funciones de [bases de datos relacionales]({{< relref "posts/relationale-datenbank" >}}) y [vinculación de tablas]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}})
