...
- [Relational database]({{< relref "posts/relationale-datenbank" >}}) functions and the [linking of tables]({{< relref "help/base-editor/spaltentypen/die-verknuepfungsspalte" >}})
